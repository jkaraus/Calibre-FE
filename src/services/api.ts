...
import type { Book, RecentBooksParams, BooksCountResponse, AuthorsCountResponse } from '../types/book'
...
const fetchFromAPI = async <T>(endpoint: string): Promise<T> => {
  ...
  try {
    ...
    console.log('Received data length:', Array.isArray(data) ? data.length : 'N/A')
    return data
  } catch (error) {
...
// Books API functions
const fetchRecentBooks = async (params: RecentBooksParams = {}): Promise<Book[]> => {
